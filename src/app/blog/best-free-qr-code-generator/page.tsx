    ...
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", background: "#f7fafc", minHeight: "100vh", color: "#181c1e" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "48px 20px 64px" }}>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <p style={{ fontSize: 15, color: "#4a5568", lineHeight: 1.75, margin: 0 }}>Ad-supported platforms break this model by funding redirect infrastructure through advertising revenue rather than subscriptions. A platform generating 100,000 monthly visitors produces sufficient advertising revenue to cover VPS hosting, Redis cache, and bandwidth for millions of redirects, making unlimited free dynamic QR codes economically viable without subscription revenue.</p>
        </section>
