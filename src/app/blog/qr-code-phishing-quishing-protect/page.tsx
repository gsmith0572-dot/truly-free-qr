    ...
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", background: "#f7fafc", minHeight: "100vh", color: "#181c1e" }}>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "48px 20px 64px" }}>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <p style={{ ...pStyle, margin: 0 }}>The numbers are staggering. The FBI&apos;s Internet Crime Complaint Center reported a 400% increase in quishing attacks from 2023 to 2025. Attackers love QR codes because users are trained to scan them without thinking. Restaurants, parking meters, and event tickets are prime targets.</p>
        </section>
