...
const POSTS = [
  { slug: "qr-codes-for-home-services-plumbers-electricians-and-contrac", label: "HOW-TO GUIDE", labelColor: "#16a34a", title: "QR codes for home services: plumbers, electricians, and contractors", excerpt: "Learn how home service professionals can use QR codes to streamline customer communication, share pricing, schedule appointments, and grow their business.", readTime: "9 min read", date: "September 2026" },
  { slug: "how-small-businesses-use-qr-codes-to-compete-with-larger-cha", label: "HOW-TO GUIDE", labelColor: "#16a34a", title: "How Small Businesses Use QR Codes to Compete with Larger Chains", excerpt: "Discover practical ways small businesses leverage QR codes to level the playing field against big\u2011box chains, from loyalty programs to dynamic pricing.", readTime: "9 min read", date: "September 2026" },
  { slug: "qr-codes-for-accountants-and-financial-advisors", label: "PROFESSIONAL SERVICES", labelColor: "#0058c3", title: "QR Codes for Accountants and Financial Advisors", excerpt: "How QR technology can streamline client onboarding, protect sensitive data, and turn routine paperwork into a frictionless digital experience.", readTime: "8 min read", date: "August 2026" },
  { slug: "qr-codes-for-insurance-agents-and-brokers", label: "PROFESSIONAL SERVICES", labelColor: "#7c3aed", title: "QR Codes for Insurance Agents and Brokers", excerpt: "How to use free, ad-supported QR codes to speed up onboarding, deliver policy documents, and generate more leads.", readTime: "8 min read", date: "August 2026" },
  { slug: "qr-codes-for-pharmacies-and-medical-supply-companies", label: "HEALTHCARE", labelColor: "#16a34a", title: "QR Codes for Pharmacies and Medical Supply Companies", excerpt: "Discover how QR codes can streamline operations and improve patient engagement for pharmacies and medical supply companies.", readTime: "7 min read", date: "August 2026" },
  { slug: "how-to-use-qr-codes-in-email-campaigns", label: "MARKETING", labelColor: "#ea580c", title: "How to Use QR Codes in Email Campaigns", excerpt: "Learn how to effectively use QR codes in your email campaigns to boost engagement and drive conversions.", readTime: "6 min read", date: "July 2026" },
  { slug: "qr-code-size-guide-minimum-size-for-print-fabric-and-outdoor", label: "QR CODE GUIDES", labelColor: "#0058c3", title: "QR Code Size Guide: Minimum Size for Print, Fabric, and Outdoor Signage", excerpt: "Learn the minimum QR code size for print, fabric, and outdoor signage to ensure your codes are scannable and effective.", readTime: "7 min read", date: "July 2026" },
  { slug: "qr-codes-for-spas-and-salons-booking-links-and-loyalty-progr", label: "SPAS & SALONS", labelColor: "#7c3aed", title: "QR Codes for Spas and Salons: Booking Links and Loyalty Programs", excerpt: "Discover how QR codes can transform your spa or salon business by streamlining bookings and loyalty programs.", readTime: "6 min read", date: "July 2026" },
  { slug: "qr-code-for-churches-nonprofits", label: "NONPROFITS & CHURCHES", labelColor: "#16a34a", title: "Free QR Code for Churches and Nonprofits (Never Expires)", excerpt: "Generate free dynamic QR codes for churches, nonprofits, and charities. Update donation links, event pages, and bulletins without reprinting.", readTime: "7 min read", date: "June 2026" },
