...
const POSTS = [
  ...
  { slug: "dynamic-vs-static-qr-code", label: "QR CODE GUIDES", labelColor: "#0058c3", title: "Dynamic vs Static QR Code: What's the Difference?", excerpt: "You're printing new business cards. Your designer asks: \"Dynamic or static QR code?\" You have no idea. You Google it. The results are full of marketing jargon from companies trying to sell you subscriptions.", readTime: "12 min read", date: "June 2026" },
  ...
  { slug: "qr-code-phishing-quishing-protect", label: "SECURITY", labelColor: "#dc2626", title: "What Is QR Code Phishing (Quishing)?", excerpt: "You see a QR code on a parking meter. It promises \"easy payment via app.\" You scan it. It takes you to a website that looks like the official parking app. You enter your credit card info. Two days later, you see $500 in fraudulent charges.", readTime: "12 min read", date: "June 2026" },
  ...
  { slug: "best-free-qr-code-generator-2026", label: "HONEST COMPARISON", labelColor: "#0058c3", title: "Best Free QR Code Generator in 2026 (No Subscription)", excerpt: "You need a QR code. You search \"best free QR code generator.\" The results are overwhelming. Dozens of tools, each claiming to be free. But when you dig in, you find limits: dynamic codes expire after 14 days.", readTime: "12 min read", date: "June 2026" },
