...
export const metadata: Metadata = {
  ...
  description: "Bitly QR costs $35 per month – $420 a year. There are free alternatives that do the same thing – and some do more. Here are the real alternatives to Bitly QR, ranked honestly.",
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "Does Bitly's free tier include dynamic QR codes?", acceptedAnswer: { "@type": "Answer", text: "No. Bitly's free tier only offers static QR codes. Dynamic codes require the $35/month plan. So if you see \"free QR code\" on Bitly, it's static – you cannot edit the destination later. That's fine for permanent links, but useless for menus, events, or anything that might change." } },
    ...
    <div style={{ fontFamily: "Inter, system-ui, sans-serif", background: "#f7fafc", minHeight: "100vh", color: "#181c1e" }}>
      ...
      <div style={{ background: "linear-gradient(160deg,#08122a 0%,#0c1e45 55%,#08122a 100%)", color: "#fff", padding: "56px 20px 44px" }}>
        <div style={{ maxWidth: 760, margin: "0 auto" }}>
          ...
          <p style={{ fontSize: 16, color: "rgba(255,255,255,0.65)", lineHeight: 1.65, margin: "0 0 24px" }}>You need a QR code for your new product launch. You see Bitly offers QR codes. $35 per month. You pause. That&apos;s $420 a year. For a QR code. You start searching for alternatives.</p>
      ...
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "48px 20px 64px" }}>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <p style={pStyle}>You need a QR code for your new product launch. You&apos;ve used Bitly for link shortening before. You see they offer QR codes. $35 per month. You pause. That&apos;s $420 a year. For a QR code. You start searching for alternatives.</p>
          <p style={pStyle}>Bitly is a great link shortener. Their QR product is overpriced. $35 a month gets you dynamic QR codes, basic analytics, and the ability to edit destinations. That&apos;s it. No anti-phishing. No custom colors beyond basic. No logo embedding. For a small business, that&apos;s a rip-off. There are free alternatives that do the same thing – and some do more.</p>
        ...
        <section style={{ marginBottom: 40 }}>
          ...
          <p style={pStyle}>Let me start with Bitly&apos;s actual pricing. Their QR code feature is included in the &quot;Custom&quot; plan at $35 per month when billed annually ($420 per year). Month-to-month is $55 per month ($660 per year). What do you get? Dynamic QR codes (editable destination), basic scan analytics (counts, device types, approximate location), and the ability to brand your short domain if you pay even more. No anti-phishing. No logo embedding. No free tier for dynamic codes – their free tier only gives you static QR codes.</p>
          <p style={pStyle}>Alternative #1: QR Code Generator (qr-code-generator.com). Their free dynamic codes expire after 14 days. Paid plans start at $9 per month ($108 per year). That&apos;s cheaper than Bitly but still a subscription. Their analytics are more detailed than Bitly&apos;s. They offer logo embedding. But the expiration trap is real. I&apos;ve heard horror stories from business owners who printed codes and got deactivated on day 15.</p>
          ...
          <p style={pStyle}>Alternative #3: QRCode Monkey. Free static codes. Dynamic codes require $19 per month ($228 per year). That&apos;s more than QR Code Generator but less than Bitly. Their dynamic codes don&apos;t expire as long as you pay. But they have no free dynamic tier at all. You pay or you use static.</p>
          <p style={{ ...pStyle, margin: 0 }}>Alternative #4: Truly Free QR. Dynamic codes, no expiration, scan analytics, custom colors, logo embedding, anti-phishing Safe-Scan. Cost: $0. No subscription. No account. Funded by AdSense. The only tradeoff is you see ads on the generator dashboard. Not on the scan redirect. Not on your printed materials. Just on the website when you create codes.</p>
        </section>
